...
namespace BI.PivotGrid
{
    ...
    public sealed partial class CustomSummaries : SampleLayout
    {
        ...
        /// <summary>
        /// This event handler method is hooked when clicking the checkbox.
        /// </summary>
        ...
        /// <summary>
        /// This event handler method is hooked when the combobox item was selected.
        /// </summary>
        ...
        private void cmbBoxPadString_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (pivotGrid1.PivotCalculations.Count == 0)
                return;
            int i = pivotGrid1.PivotCalculations.IndexOf(pivotGrid1.PivotCalculations.Where(x => x.FieldName == "Value3").FirstOrDefault());
