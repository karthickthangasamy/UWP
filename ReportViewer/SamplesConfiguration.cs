    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                ...
                DesktopImage = "ms-appx:///ReportViewer/Assets/Territory Sales.jpg",
                MobileImage = "ms-appx:///ReportViewer/Assets/Territory Sales mobile.jpg",
                ProductIcons = "ms-appx:///ReportViewer/Assets/reportviewer.png",
                Description = "This sample demonstrates how the report viewer control can be used for viewing RDL files hosted on a SSRS server.",
